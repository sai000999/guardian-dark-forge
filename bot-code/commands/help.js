...
module.exports = {
  ...
  async execute(interaction, client) {
    const embed = new EmbedBuilder()
      ...
      { 
        name: '👋 Welcomer System (Admin)', 
        value: '`/welcome` - Configure welcome messages, auto-role, DM messages, and auto-decancer\n• Set custom embeds for channel and DM welcomes\n• Auto-assign roles to new members\n• Remove special characters from usernames', 
        inline: false 
      },
      { 
        name: '📋 Logging System (Admin)', 
        value: '`/logging` - Set up automated server logs\n• **Server Logs:** Member joins/leaves, role & channel changes\n• **Message Logs:** Edits, deletes, and purges\n• **Mod Logs:** All moderation actions', 
        inline: false 
      },
      { 
